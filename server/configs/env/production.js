 ...
 * configure your app for production.  The configuration in this file is only
 * used in your production environment, i.e. when you start your app using:
 *
 * ```
...
global.Constant = {
    ...
    /***************************************************************************
     * 
     * * Tell your app what database(s) it should use in production.
     * 
     **************************************************************************/
    DATABASE: {

        /***********************************************************************
        * * Configure your MongoDB production database.
        *
        ...
        *
        ...
        /***********************************************************************
        * * Configure your Redis production database.
        *
        * 1. Define database name:
        *    (For example: DB_1, DB_2, ..., DB_n)
        *
        ...
        *
        ...
        /***********************************************************************
        * * Configure your Elastic search production database.
        *
        * 1. Define database name:
        *    (For example: DB_1, DB_2, ..., DB_n)
        *
